...
public class ScanActivity extends AppCompatActivity {
    ...
    private void startMainActivity() {
        ...
        intent.putExtra(MainActivity.EXTRAS_DEVICE_NAME, deviceNames);
        intent.putExtra(MainActivity.EXTRAS_DEVICE_ADDRESS, deviceAddresses); //Might need different Extras for each device
